  ...
  setup(props, { emit }) {
    ...
    async function onMountedCallback() {
      ...
      function onMousedownGradient(position) {
        ...
        const a =
          end.offset - position.x - (position.x - start.offset) > 0 ? startRGBA[3] : endRGBA[3];
    ...
    onBeforeUnmount(() => {
      paletteMoveable && paletteMoveable.destroy();
      sliderHuxMoveable && sliderHuxMoveable.destroy();
      sliderAlphaMoveable && sliderAlphaMoveable.destroy();
      unwatchHSLA();
    ...
    function updateColorData(hexA) {
      ...
      alpha.value = Math.round((hsla.a != null ? hsla.a : 1) * 100);
    }
    ...
    return {
      ...
      elSliderHuxPointer,
      elSliderAlpha,
      elSliderAlphaPointer,
      onChangeMode,
      onChangeHex,
      onMousedownGradientPointer,
      onKeyupGradientPointer,
      onClickStraw,
      onInputBlur,
      angleChange,
      updateValue,
