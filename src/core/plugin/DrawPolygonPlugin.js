...
class DrawPolygonPlugin {
    constructor(canvas, editor) {
        ...
        this._moveHandler = (ev) => {
            if (!this.isDrawingPolygon || !this.tempLine)
                return;
...
DrawPolygonPlugin.pluginName = 'DrawPolygonPlugin';
DrawPolygonPlugin.apis = ['beginDrawPolygon', 'endDrawPolygon', 'discardPolygon'];
