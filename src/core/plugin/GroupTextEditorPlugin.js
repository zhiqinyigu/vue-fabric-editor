...
class GroupTextEditorPlugin {
    ...
    _bedingTextEditingEvent(textObject, groupObj) {
        ...
        const newX = a * ((_a = textObject.left) !== null && _a !== void 0 ? _a : 0) + c * ((_b = textObject.top) !== null && _b !== void 0 ? _b : 0) + e;
        const newY = b * ((_c = textObject.left) !== null && _c !== void 0 ? _c : 0) + d * ((_d = textObject.top) !== null && _d !== void 0 ? _d : 0) + f;
        const tempText = new textObject.constructor((_e = textObject.text) !== null && _e !== void 0 ? _e : '', {
            ...textObjectJSON,
