...
class ControlsRotatePlugin {
    ...
    init() {
        ...
        canvas.on('after:render', () => {
            ...
            const angle = (_a = activeObj === null || activeObj === void 0 ? void 0 : activeObj.angle) === null || _a === void 0 ? void 0 : _a.toFixed(2);
            if (angle !== undefined) {
        ...
        canvas.on('object:rotating', (event) => {
            ...
            const angle = (_b = (_a = canvas.getActiveObject()) === null || _a === void 0 ? void 0 : _a.angle) === null || _b === void 0 ? void 0 : _b.toFixed(2);
            if (angle === undefined)
                return;
            switch ((_c = event.transform) === null || _c === void 0 ? void 0 : _c.corner) {
                case 'mtr':
...
ControlsRotatePlugin.pluginName = 'ControlsRotatePlugin';
