...
class CanvasRuler {
  ...
  showGuideline() {
    ...
    (_b =
      (_a = this === null || this === void 0 ? void 0 : this.options) === null || _a === void 0
        ? void 0
        : _a.canvas) === null || _b === void 0
      ? void 0
      : _b.getObjects(fabric.GuideLine.prototype.type).forEach((guideLine) => {
          guideLine.set('visible', true);
        });
    (_d =
      (_c = this === null || this === void 0 ? void 0 : this.options) === null || _c === void 0
        ? void 0
        : _c.canvas) === null || _d === void 0
      ? void 0
      : _d.renderAll();
  }
  /**
  ...
  render() {
    ...
    this.draw({
      ...
      startCalibration: ((_a = this.startCalibration) === null || _a === void 0 ? void 0 : _a.x)
    ...
    this.draw({
      ...
      startCalibration: ((_b = this.startCalibration) === null || _b === void 0 ? void 0 : _b.y)
    ...
    const allRect = activeObjects.reduce((rects, obj) => {
      ...
      if (obj.group) {
        ...
        const objectOffsetFromCenterX =
          (group.width / 2 + ((_a = obj.left) !== null && _a !== void 0 ? _a : 0)) *
          (1 - group.scaleX);
        ...
        const objectOffsetFromCenterY =
          (group.height / 2 + ((_b = obj.top) !== null && _b !== void 0 ? _b : 0)) *
          (1 - group.scaleY);
  ...
  canvasMouseUp(e) {
    ...
    this.activeOn = 'up';
    (_a = this.tempGuidelLine) === null || _a === void 0
      ? void 0
      : _a.fire('up', this.getCommonEventInfo(e));
